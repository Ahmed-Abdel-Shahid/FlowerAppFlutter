...
// backgroundColor: Color.fromARGB(66, 73, 127, 110),
                ...
                // items[index].price)
                      ...
                      title: Text(
                        " ${items[index].name}",style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                );
              ...
              children: [
                Column(
                  children: [
                    UserAccountsDrawerHeader(
                      ...
                      accountEmail: Text("ahmed4230482@gmail.com"),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Text("Developed by Ahmed mohamed © 2023",
